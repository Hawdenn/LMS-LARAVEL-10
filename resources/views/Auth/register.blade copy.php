        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <form action="{{ route('registrasi') }}" class="login100-form validate-form" method="POST"
                    ...
                    <!-- Add the remaining input fields in your form -->
                    ...
                    <div class="wrap-input100 validate-input">
                        <label for="agama" class="input100">Agama</label>
                        <div class="select-container">
                            <select class="input100" id="agama" name="agama">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Umur is required">
                        <input class="input100" type="text" name="umur">
                        <span class="focus-input100"></span>
                    ...
                    <div style="margin: 20px 20px 40px 20px;">
                        <label for="gambar"
                            style="margin-buttom: 10px; font-size: 16pt; color:#666666;">Foto Profile   </label>
